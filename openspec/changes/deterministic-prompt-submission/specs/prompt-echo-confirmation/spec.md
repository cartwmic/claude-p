...
|---|---|---|---|---|---|
| prompt-echo-confirmation.prompt-delivery-readiness-is-event-gated | [x] | [x] | [x] | [x] | [x] |
| prompt-echo-confirmation.prompt-delivery-uses-bracketed-paste | [x] | [x] | [x] | [x] | [x] |
| prompt-echo-confirmation.transcript-user-record-confirms-submission | [x] | [x] | [x] | [x] | [x] |
| prompt-echo-confirmation.replayed-history-does-not-confirm-submission | [x] | [x] | [x] | [x] | [x] |
| prompt-echo-confirmation.submission-handshake-has-no-liveness-timeout | [x] | [x] | [x] | [x] | [x] |
| prompt-echo-confirmation.prompt-not-accepted-is-positive-signal-only | [x] | [x] | [x] | [x] | [x] |
