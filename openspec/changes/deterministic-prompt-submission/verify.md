...
| 4 | Commit hygiene (subject ≤72; body explains why) | pass | Worktree commits from `3fdbcd3..HEAD` have subjects ≤72 and are scoped to the change/implementation; rationale is carried in proposal/plan/task artifacts |
